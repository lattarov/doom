...
(defun vlv-format-org-elisp-blocks ()
  "Reindent all emacs-lisp src blocks in the current org buffer."
  (interactive)
  (save-excursion
    (goto-char (point-min))
...
;; Auto-format before every tangle
(add-hook 'org-babel-pre-tangle-hook #'vlv-format-org-elisp-blocks)
#+end_src

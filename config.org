...
#+begin_src emacs-lisp :tangle packages.el
(package! org-gtd
  :pin "3dd86c08048257b91d793aaf7cde9c09ad4c833c")
#+end_src
...
(package! llm-tool-collection
  :pin "b9fd45bedf3e0fb07d289730991199ae18785157"
  :recipe '(:host github
...
#+begin_src emacs-lisp :tangle packages.el
(package! gptel-agent
  :pin "7a74b695909c0e3304eb8cbd583a1f53e0802c60"
  :recipe '(:host github
...
#+begin_src emacs-lisp :tangle packages.el
(package! bug-hunter
  :pin "e89621287d14c8cc73cd78c63ef49595fbfd745f")
#+end_src
...
#+begin_src emacs-lisp :tangle packages.el
(package! fzf
  :pin "75060d81f4eea3f8088ac2a4a3a253c686b44d44")
#+end_src
...
To be used in yocto workflows.
 ...
 #+begin_src emacs-lisp :tangle packages.el
(package! bitbake
  :pin "f626d37727df0550aa2afd3f1b0ce81f38be18a3")
(package! bitbake-ts-mode
  :pin "f3ebbae4c09584774b99e4ada568fdf9451b69be")
#+end_src
...
(package! mastodon
  :disable (vlv-env-work-p)
  :pin "5ddf28b9454ad9ee12738f9467e3ad013b788ee3")
#+end_src
...
#+begin_src emacs-lisp :tangle packages.el
(package! alarm-clock
  :pin "8a805d365aa38be32041c4e968bb624d3bb1b54b")
#+end_src
...
#+begin_src emacs-lisp :tangle packages.el
;; NOTE: not currently pinned — these are :disable'd on PERSONAL and have
;; never been cloned on this machine, so there's no resolved commit to pin
;; to yet. Pin them the next time they're enabled and synced on a WORK
;; machine (see docs/dependency-provenance.md).
(package! robot-mode
  :disable (vlv-env-personal-p))
...
#+begin_src emacs-lisp :tangle packages.el
(package! dts-mode
  :pin "cd1847d0e7162c1ecab772c6ca7ef4f3c5d2214d")
#+end_src

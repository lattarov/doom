...
(use-package! consult-omni
  ...
  (setq consult-omni-sources-modules-to-load (list 'consult-omni-wikipedia 'consult-omni-notes 'consult-omni-elfeed 'consult-omni-duckduckgo 'consult-omni-file 'consult-omni-buffer 'consult-omni-buffer-search 'consult-omni-dict 'consult-omni-invidious))

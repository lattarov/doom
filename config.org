...
(after! gptel
  ...
  (setopt gptel-backend (gptel-make-ollama "Ollama"
          ...
          :stream t
          :models '((deepseek-coder-v2:16b) (ifioravanti/llamantino-2) (deepseek-r1:8b) (deepseek-r1:7b)))))
#+end_src
...
(when (string-equal vlv/environment "PERSONAL")
...
"Transient menu for selecting a TightVNC machine."
    ...
    ("b" "BDT-INCA10-VERN"   (lambda () (interactive) (vlv/connect-to-vnc-with-machine "BDT-INCA10-VERN")))
...
(map! :leader
      :prefix "o"
      :desc "WindRiver Workbench" "w" #'vlv/open-windriver-workbench)
#+end_src
...
(use-package! org
  :defer t
  :config
    (when (string-equal vlv/environment "WORK")
